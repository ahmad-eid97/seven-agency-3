<template>
    <section class="what">
        <div class="row m-0">
            ...
            <div class="col-lg-6 text" style="padding: 80px 0 60px">
                <div class="row m-0 ">
...
<style lang="css">
 ...
 .what .heading-spacer svg {
    color: var(--main-color);
    font-size: 26px;
 }
 .what .heading-spacer::before {
    content: "";
    position: absolute;
    bottom: 50%;
    right: 0;
 ...
 .what .item .item-text h3 {
    color: rgb(51, 51, 51);
    font-size: 20px;
    line-height: 30px;
    margin: 0;
 }
 .what .item .item-text p {
    color: rgb(133, 134, 140);
    float: left;
    font-size: 16px;
    margin-top: 10px;
