<template>
    <section class="intro-sec">
        ...
        <img src="/assets/images/animatedBack.png" alt="animatedBackground" class="animatedBackground">
            ...
            <div class="intro">
                <div class="row m-0 align-items-center justify-content-center">
                    <div class="col-auto text-center">
                        ...
                        <h1 class="animatedLeft"><span>Hi!</span> WE ARE <br> LARAVADA</h1>
                        <p class="animatedRight">
                            Modern creative digital agency
                        </p>
                        <img class="scrolldown animatedDown" src="//the7.io/agency/wp-content/uploads/sites/43/2021/09/arrow-down-40.png" alt="">
                    </div>
        ...
        <header :class="!topOfPage ? 'onScroll' : '' ">
            <b-navbar  toggleable="lg">
                <b-navbar-brand href="#">
                    <img src="/assets/images/logo.png" alt="logoImage" style="width: 250px" class="navLogo">
                </b-navbar-brand>
